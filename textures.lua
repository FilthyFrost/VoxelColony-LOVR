...
function T.loadAll()
    return {
        ...
        oak_trapdoor      = T.trapdoor(),
        -- New Plains village blocks (reuse similar textures)
        smooth_stone      = T.stone(),
        smooth_stone_slab = T.stone(),
        stone_stairs      = T.stoneBricks(),
        stone_brick_stairs= T.stoneBricks(),
        cobblestone_slab  = T.cobblestone(),
        stone_slab        = T.stoneBricks(),
        dark_oak_log      = T.darkOakPlanks(),
        dark_oak_slab     = T.darkOakPlanks(),
        dark_oak_fence    = T.darkOakPlanks(),
        oak_fence         = T.oakPlanks(),
        oak_fence_gate    = T.oakPlanks(),
        stripped_oak_log   = T.oakPlanks(),
        barrel            = T.chest(),
        smoker            = T.cobblestone(),
        blast_furnace     = T.cobblestone(),
        composter         = T.oakPlanks(),
        lectern           = T.oakPlanks(),
        loom              = T.oakPlanks(),
        stonecutter       = T.stone(),
        cartography_table = T.oakPlanks(),
        fletching_table   = T.oakPlanks(),
        grindstone        = T.stone(),
        anvil             = T.cobblestone(),
        cauldron          = T.cobblestone(),
        bell              = T.chest(),
        campfire          = T.oakLog(),
        hay_bale          = T.oakPlanks(),
        dirt_path         = T.dirt(),
        water             = T.glass(),
    }
end
